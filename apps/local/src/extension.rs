...
//!
//! One answer, because there were two and they disagreed. `local image` named a JPEG `.jpeg` while
//! `local favicon` named one `.jpg` -- the same format, spelled for an eight-character filename
