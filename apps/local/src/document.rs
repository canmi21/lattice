...
/// indistinguishable from one declaring nothing -- `local articles` skipped those silently.
///
...
/// unreadable is a fault for `local check` to report; answering "draft" here would quietly remove
