//! The `local diagram` command: describing a drawing that is written as text.
//!
...
/// any other language would be translating them on the way out. `local locale` fills the rest.
